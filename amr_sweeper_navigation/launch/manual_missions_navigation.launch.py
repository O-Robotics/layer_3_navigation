...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            "params_file",
            default_value=os.path.join(bringup_dir, "config", "manual_missions_navigation.yaml"),
            description="Full path to the Nav2 parameter file",
        ),
        DeclareLaunchArgument(
            "mission_static_costmap_yaml",
            default_value="",
            description="Exact mission run static costmap YAML from execution_context.json.",
        ),
