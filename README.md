...
- Nav2 runtime parameters now live in mission-class-specific files under `amr_sweeper_navigation/config/`; Nav2 consumes mapping-published `mapping/global_costmap` for global planning and builds its rolling local costmap directly from live sensor topics.
